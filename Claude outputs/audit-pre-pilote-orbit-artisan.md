...
**Prochaine étape** : Vague 1, Vague 2, Vague 3 et Vague 4 terminées et vérifiées (eslint + tsc clean, tests unitaires verts sur chaque commit ; 144 tests toujours au vert). "Facturer" reste gelé et la vitrine publique reste désactivée — Vague 3 est du code prêt en attente de l'exécution de la migration 21 (voir contrôle anti-chevauchement ci-dessus) avant réactivation de la vitrine ; Vague 2 attend l'exécution de la migration 20 et ta décision sur la date de dégel de "Facturer". Il ne reste plus que l'autoliquidation sous-traitance (Vague 4, point 8) en suspens, bloquée sur ta réponse : un des 5 artisans pilotes sous-traite-t-il pendant le mois de test ?
